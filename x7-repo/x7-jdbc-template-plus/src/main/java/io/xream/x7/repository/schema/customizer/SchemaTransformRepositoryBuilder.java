 ...
 */
package io.xream.x7.repository.schema.customizer;

import io.xream.x7.common.bean.SchemaTransform;
...
public class SchemaTransformRepositoryBuilder {
    ...
    public Class<? extends BaseRepository> build(Class<? extends BaseRepository> clzz){
...

        {
            ...
            if (!flag)
                throw new RuntimeException("SchemaTransform Customized Class has to implements Transformed");
        }
